  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        voice: {
          1: "hsl(var(--voice-color-1))",
          2: "hsl(var(--voice-color-2))",
          3: "hsl(var(--voice-color-3))",
          4: "hsl(var(--voice-color-4))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        'premium': '0 4px 20px hsl(var(--gold) / 0.3)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "voice-wave": "voice-wave 0.8s ease-in-out infinite alternate",
